...
contract poolSepolia is UUPSUpgradeable, SecurityUpgradeable, AutomationCompatibleInterface {
    ...
    function initialize(
        ...
        s_priceFeedETH = IPriceAgregadorV3(0x694AA1769357215DE4FAC081bf1f309aDC325306); //Sepolia
    ...
    function setHypnosPoint(address _hypnos) public {
        s_hypnosPoint = _hypnos;
    }

    function setBetUSD(address _betUSD) public {
        s_betUSD = _betUSD;
    }
